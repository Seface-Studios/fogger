...
import net.sefacestudios.config.blockOutlineColor.BlockOutlineConfigData;
import net.sefacestudios.config.fogColor.FogConfigData;
import net.sefacestudios.config.skyColor.SkyConfigData;
import net.sefacestudios.config.waterColor.WaterConfigData;
import net.sefacestudios.config.waterFogColor.WaterFogConfigData;
