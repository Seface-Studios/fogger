...
import net.sefacestudios.commands.KaleidoscopeCommand.KaleidoscopeCommand;
//#else
//$$ import net.fabricmc.fabric.api.client.command.v2.ClientCommandRegistrationCallback;
//#endif
...
public class RegisterCommands {
    public static void register() {
        //#if MC<11900
        ClientCommandRegistrationCallback.EVENT.register(((dispatcher, registryAccess) -> KaleidoscopeCommand.register(dispatcher)));
        //#else
        //$$ ClientCommandRegistrationCallback.EVENT.register(((dispatcher, registryAccess) -> KaleidoscopeCommand.register(dispatcher)));
        //#endif
    }
