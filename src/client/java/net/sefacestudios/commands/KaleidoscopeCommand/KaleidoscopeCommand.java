...
package net.sefacestudios.commands.KaleidoscopeCommand;
...
import net.sefacestudios.config.KaleidoscopeConfig;
import net.sefacestudios.utils.Messenger;
...
public class KaleidoscopeCommand {
    ...
    private static int help(ClientPlayerEntity player) {
        ...
        player.sendMessage((Text) Messenger.s(commandHelpDoc).getStyle().withFormatting(Formatting.LIGHT_PURPLE), false);
        return 1;
    }
}
